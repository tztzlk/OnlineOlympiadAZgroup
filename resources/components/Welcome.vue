  ...
  <section class="hero">
    ...
    <div class="hero__wrapper">
      ...
      <div class="hero__visual" aria-hidden="true">
        <!-- Yellow glow circle behind trophy -->
        ...
        <div class="trophy-wrap">
          ...
          <div class="float-badge float-badge--2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#f5c842" stroke-width="2.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
            <span>1 место</span>
          </div>
          <div class="float-badge float-badge--3">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
            <span>10 мин</span>
          </div>

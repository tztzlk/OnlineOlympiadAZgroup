<template>
  <section class="news-section">
    <div class="news-header">
      ...
      <h1 class="news-title">Новости платформы и рейтинг участников</h1>
...
.read-more { display: inline-flex; margin-top: 14px; color: #22663b; text-decoration: none; font-weight: 600; transition: opacity 0.2s ease; }
@media (hover: hover) and (pointer: fine) { .read-more:hover { opacity: 0.7; } }
